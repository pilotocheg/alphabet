    ...
    return(
        <div className="container">
			<div className="s_width">
				...
				<div className="text">
					Дана програма створена для кращого засвоєння абетки з допомогою гри. Створена на реакті 4 випускниками Frond End. Використано два режима. Один - для вивчення абетки, інший - для гри. В роботі були використані картинки взяті з простор інтернету та звуки, власного запису. 
